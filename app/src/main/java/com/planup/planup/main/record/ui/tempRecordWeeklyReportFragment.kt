...
class tempRecordWeeklyReportFragment : Fragment() {
    ...
    private fun clickListener(){
        ...
        binding.checkChallengeRecordLl.setOnClickListener {
            ...
            val frag = com.planup.planup.main.home.ui.ChallengeCompleteFragment.newInstance(
    ...
    private fun callChallengePortAndBind(userId: Int) {
        ...
        challengePort.showFriends(userId).enqueue(object :
            retrofit2.Callback<com.planup.planup.network.data.ChallengeResponse<List<com.planup.planup.network.data.ChallengeFriends>>> {
            override fun onResponse(
                call: retrofit2.Call<com.planup.planup.network.data.ChallengeResponse<List<com.planup.planup.network.data.ChallengeFriends>>>,
                response: retrofit2.Response<com.planup.planup.network.data.ChallengeResponse<List<com.planup.planup.network.data.ChallengeFriends>>>
            ) {
