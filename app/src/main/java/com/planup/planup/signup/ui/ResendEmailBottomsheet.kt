...
import com.planup.planup.databinding.PopupResendEmailBinding
...
import com.planup.planup.util.KakaoServiceHandler
...
class ResendEmailBottomsheet : BottomSheetDialogFragment() {
                ...
                if (resp.isSuccessful && body?.isSuccess == true) {
                    ...
                    if (r.userStatus == UserStatus.SIGNUP_REQUIRED) {
                        ...
                        if (!accessToken.isNullOrBlank() && userInfo != null) {
                            ...
                            startActivity(Intent(requireContext(), com.planup.planup.main.MainActivity::class.java))
                            dismiss()
    ...
    private fun resendEmail() {
        val targetEmail = email.ifBlank {
            (activity as? com.planup.planup.signup.SignupActivity)?.email.orEmpty()
        }
                ...
                when (mode) {
                    ...
                    ResendMode.SIGNUP -> {
                        val res = RetrofitInstance.userApi.sendEmail(
                            com.planup.planup.signup.data.EmailSendRequestDto(targetEmail)
                        )
    ...
    companion object {
        ...
        fun newInstance(email: String, mode: ResendMode = ResendMode.SIGNUP): com.planup.planup.signup.ui.ResendEmailBottomsheet {
