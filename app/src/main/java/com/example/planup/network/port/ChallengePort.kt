...
interface ChallengePort {
    ...
    fun rejectChallenge(@Path("challengeId") challengeId: Int, @Query("userId") userId: Int): Call<ChallengeResponse<Boolean>>
    //챌린지 이름 조회
    ...
    fun acceptChallenge(@Path("challengeId") challengeId: Int, @Query("userId") userId: Int): Call<ChallengeResponse<Boolean>>
    //챌린지에서 친구 조회
    ...
    fun changePenalty(@Body repenaltyDto: RepenaltyDto): Call<ChallengeResponse<Boolean>>
    //챌린지 생성 요청
    @POST("challenges/create")
    fun createChallenge(@Body challengeDto: ChallengeDto): Call<ChallengeResponse<Boolean>>
}