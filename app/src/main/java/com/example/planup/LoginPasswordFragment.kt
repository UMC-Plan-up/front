...
class LoginPasswordFragment : Fragment(R.layout.fragment_login_password) {
    ...
    private fun enableNextButton() {  // 다음 버튼 활성화
        ...
        nextButton.backgroundTintList = ContextCompat.getColorStateList(requireContext(), R.color.blue_200)
    }

    private fun disableNextButton() {  // 다음 버튼 비활성화
        nextButton.isEnabled = false
        nextButton.backgroundTintList = ContextCompat.getColorStateList(requireContext(), R.color.black_200)
    }
}
